                    ...
                    <div>
                        ...
                        <div className="container" style={{backgroundColor: '#ffffff', width: '896px', minWidth: 141, maxWidth: '1247px', height: '400px', padding: '27px', borderRadius: '25px',marginBottom:'40px'}}>
                            <form onSubmit={this.handleSubmit}>
                                <h2 className="text-center" style={{height: '52px', minHeight: '0px'}}><strong>Create</strong> an account.</h2>
                                ...
                                <a className="already" href="/login" style={{paddingLeft: 300}}>Already have an account? Login here.</a></form>
                        </div>
                    </div>
                </div>
        );
